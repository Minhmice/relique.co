...
import { InconclusiveUpsell } from "@/components/verify/InconclusiveUpsell";
      ...
      {result && !loading && (
        <div className="space-y-6">
          <VerifyResultEnhanced
            ...
            saved={saved}
          />
          {result.status === "inconclusive" && <InconclusiveUpsell />}
...
export default function VerifyPage() {
  return (
    <Suspense fallback={<div className="space-y-8"><div className="text-center"><h1 className="text-h1">Verify Product</h1><p className="text-xl text-muted-foreground">Loading...</p></div></div>}>
      <VerifyPageContent />
    </Suspense>
  );
}
