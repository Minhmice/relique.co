...
import { SavedSearchChips } from "@/components/marketplace/SavedSearchChips";
import { Pagination } from "@/components/marketplace/Pagination";
import { EmptyState } from "@relique/ui";
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-4">
          <MarketplaceSearch />
          <SavedSearchChips currentFilters={filters} onApplySearch={setFilters} />
