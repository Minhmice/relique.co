...
const STORAGE_KEYS = {
  ...
  PORTAL_VIEWS_COLUMNS: "relique.v1.portal.views.submissions.columns",
  PORTAL_VIEWS_SAVED: "relique.v1.portal.views.submissions.saved",
  PORTAL_RECENT_SEARCHES: "relique.v1.portal.recentSearches.submissions",
  PORTAL_SAVED_FILTERS: "relique.v1.portal.savedFilters.submissions",
  PORTAL_NOTIFICATIONS: "relique.v1.portal.notifications",
  PORTAL_ALERT_RULES: "relique.v1.portal.alertRules",
...
export const storage = {
    ...
    views: {
      columns: {
        get: (): Record<string, boolean> => {
          return getItem<Record<string, boolean>>(STORAGE_KEYS.PORTAL_VIEWS_COLUMNS, {});
        },
        set: (columns: Record<string, boolean>): void => {
          setItem(STORAGE_KEYS.PORTAL_VIEWS_COLUMNS, columns);
        },
      },
      saved: {
        get: (): Array<{ id: string; name: string; filters?: unknown; sort?: unknown; columnVisibility?: Record<string, boolean>; pageSize?: number; createdAt: number }> => {
          return getItem(STORAGE_KEYS.PORTAL_VIEWS_SAVED, []);
        },
  ...
  clearAll: (): void => {
    ...
    // Also clear portal-specific keys
    const portalKeys = [
